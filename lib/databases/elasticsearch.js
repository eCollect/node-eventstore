...
const elasticsearch = Store.use('elasticsearch');
const elasticsearchVersion = Store.use('elasticsearch/package.json').version;
const debug = require('debug')('eventstore:store:elasticsearch');
